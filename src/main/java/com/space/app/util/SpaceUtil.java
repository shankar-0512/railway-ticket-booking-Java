...
public class SpaceUtil {
	...
	public static String generateTicketEmailContent(GenerateEticketRequestDTO generateRequest, ShipDetailsEntity shipDetails,
		...
		emailContent = "<!DOCTYPE html>\r\n"
				...
				+ "        </tr>\r\n"
				+ "        <tr style=\"background-color: #2e2eff\">\r\n"
				+ "          <td style=\"text-align: left; color: #ffffff; padding: 8px\">"+ bookingDetails.getBookingId() +"</td>\r\n"
				+ "        </tr>\r\n"
				+ "      </table>\r\n"
				+ "    </div>\r\n"
				+ "\r\n"
				...
				+ "      >\r\n"
				+ "        <tr style=\"background-color: #05033e\">\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Ship Name</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Class</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Boarding Station</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Arrival Station</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Journey Date</th>\r\n"
				...
				+ "          <td style=\"text-align: left; color: #ffffff; padding: 8px\">"+ duration +" hrs</td>\r\n"
				+ "        </tr>\r\n"
				+ "      </table>\r\n"
				+ "    </div>\r\n"
				+ "\r\n"
				...
				+ "      >\r\n"
				+ "        <tr style=\"background-color: #05033e\">\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Name</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Age</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Status</th>\r\n"
				...
				+ "      >\r\n"
				+ "        <tr style=\"background-color: #05033e\">\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Ticket Fare</th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">\r\n"
				+ "            Alien Propulsion Service Charge\r\n"
				+ "          </th>\r\n"
				+ "          <th style=\"text-align: left; color: #ffffff; padding: 8px\">Total</th>\r\n"
				+ "        </tr>\r\n"
				+ "        <tr style=\"background-color: #2e2eff\">\r\n"
				+ "          <td style=\"text-align: left; color: #ffffff; padding: 8px\">$"+ price +"</td>\r\n"
				+ "          <td style=\"text-align: left; color: #ffffff; padding: 8px\">$"+ serviceCharge +"</td>\r\n"
				+ "          <td style=\"text-align: left; color: #ffffff; padding: 8px\">$"+ total +"</td>\r\n"
				+ "        </tr>\r\n"
				+ "      </table>\r\n"
				+ "    </div>\r\n"
				+ "    <p>\r\n"
