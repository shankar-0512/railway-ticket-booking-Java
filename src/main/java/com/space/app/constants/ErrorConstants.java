...
public class ErrorConstants {
	...
	public static final String PREPARE_MESSAGE_ERROR = "PREPARE_MESSAGE_ERROR";
	public static final String TICKET_GENERATION_FAILED = "TICKET_GENERATION_FAILED";
	public static final String FETCH_BOOKING_DETAILS_ERROR = "FETCH_BOOKING_DETAILS_ERROR";
	public static final String PASSWORD_SAVE_FAILED = "PASSWORD_SAVE_FAILED";
	public static final String GENERATE_OTP_ERROR = "GENERATE_OTP_ERROR";
	public static final String OTP_DELETION_ERROR = "OTP_DELETION_ERROR";
	public static final String EMAIL_EXCEPTION = "EMAIL_EXCEPTION";
	public static final String CANCELLATION_ERROR = "CANCELLATION_ERROR";
